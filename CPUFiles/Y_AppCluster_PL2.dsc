...
//									section .ydataaudiblemetadata		MP3_COPY;
                ...
                cluster Y_Sys2 { //here's 1k of memory we need to fill with something.
                    amode Y_far {
//                        section .yconstnandsystemdrivereadsector;    //move to Y_EXTRA
//						section GeqCoefmem;            //move to Y_EXTRA
//                        section FgndModuleTable;     //move to Y_EXTRA
                        //section .ybssphilips5767;
                        section .ydataaudiblemetadata;
//                        section SYSFUN_Brownout_Y;   //move to Y_EXTRA
                        //section .ybssplaylist2;   //move to Y_EXTRA
                        //section .ydataplaylist2;  //move to Y_EXTRA
//                        section .ybsskeydefis;
						//section .ybssddiproject;  //move to Y_EXTRA
 						//section .ydataddiproject; //move to Y_EXTRA
//						section .yovlsteppingvoltageset;    //move to Y_EXTRA
//						section .ydataframebuffer;
//						section .ydatanandhaltype1descriptors;
//						section .ybssplayerlib;
//						section .ybsssetcwdhandle;   //move to Y_EXTRA
//                        section .yconstdisplay;    //move to Y_EXTRA
//                        section .yconstfsutilsc;   //move to Y_EXTRA
                        section .yconstvbr;
//                        section .ydatamicbias;     //move to Y_EXTRA
                        section .ybsssettimemenu;
                        section .ybssdetectsilence;
                        section .yovlstfm1000testpresence;

                        section .ybssnandmediadefaults;
