...
// may 2006: changed from 6 to 7 and added last line. July changed from 7 to 8 and added 1 more 
// line for 3rd real resource.bin.
// july7 2006: changed from 7 to 8 and added 2nd to last line
...
{
    {
        ...
        6,DriveTypeSystem,DRIVE_TAG_RESOURCE_BIN,50176,FALSE,
        7,DriveTypeSystem,DRIVE_TAG_RESOURCE_BIN,50176,FALSE,
        8,DriveTypeSystem,DRIVE_TAG_HOSTRSC_BIN,50176,FALSE
...
extern Resource;
// both incremented july7 2006 for extra resource.bin copy. MMC not supported in sdk3.
#ifdef MMC
  #define NUM_LOGICAL_DRIVES  10
#else
  #define NUM_LOGICAL_DRIVES  9
#endif
...
///////////////////////////////////////
// New global instead of just the MAX_LOGICAL_DRIVES define in driver plib, allows 
...
// If you change these drive numbers, also change sysmacro.asm GetLogicalDriveNumForResourceBin
LOGICAL_DRIVE g_Drive[MAX_LOGICAL_DRIVES]=
{
    ...
    {&g_DriveDescriptor[NUM_LOGICAL_MEDIA+1],&NANDSystemDriveApi}, // stmpsys.sb ?
    {&g_DriveDescriptor[NUM_LOGICAL_MEDIA+2],&NANDSystemDriveApi}, // hostlink.sb ?
    {&g_DriveDescriptor[NUM_LOGICAL_MEDIA+3],&NANDSystemDriveApi}, // hostrsrc.bin ?
    {&g_DriveDescriptor[NUM_LOGICAL_MEDIA+4],&NANDSystemDriveApi}, 
    {&g_DriveDescriptor[NUM_LOGICAL_MEDIA+5],&NANDSystemDriveApi}, 
    {&g_DriveDescriptor[NUM_LOGICAL_MEDIA+6],&NANDSystemDriveApi}, 
    {&g_DriveDescriptor[NUM_LOGICAL_MEDIA+7],&NANDSystemDriveApi}  
};
...
int g_FlashWriteOccurFlag = DISABLE_DETECTION_MASK;
#endif
////////////////////////////////////////////////////////////////////////////////
// Prototypes
////////////////////////////////////////////////////////////////////////////////
...
//added by samuel on 31/1/05 for flash write detection
/*
 ...
 */ 
    ...
    #pragma asm
        ...
        extern RSRC_FUNCLET_WRITE_DETECTION_ACCESS
        CallFunclet RSRC_FUNCLET_WRITE_DETECTION_ACCESS

        org p,"SYSFUNCLET_WRITE_DETECTION_ACCESS_P":
        dc      RSRC_FUNCLET_WRITE_DETECTION_ACCESS
    #pragma endasm    
_reentrant int write_detection_access_Funclet(int option)
#else
