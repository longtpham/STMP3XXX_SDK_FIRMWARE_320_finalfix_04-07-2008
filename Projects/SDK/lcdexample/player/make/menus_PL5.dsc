...
section .ptextplaylist5_browsemenu          MP3_COPY;
section .ptextpl5_browsemenu_extra          MP3_COPY;
section .ptextplaylist5_browse_submenu      MP3_COPY;
...
{   overlay {
        ...
        {   overlay
            ...
            overlay
            {
                section .ptextplaylist5init         MP3_COPY;
                section .ptextplaylist5             MP3_COPY;
            }
        }
    }
