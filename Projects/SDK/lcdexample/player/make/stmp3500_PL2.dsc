...
#define INT_P_SYS_SZ     0x44C4 //0x41ec //0x43E3 //0x437e //(0x3FEA + 0x210 + 0x5b + 0xD2 + 0x64+0xb7+9)
...
#define INT_X_SYS_SZ     (0x1647+7+166+8) //0x1569//0x1505 //0x1450  //(0x1447 + 105 + 3) //increase INT_X_SYS_SZ by x100 & decrease X_APP_SZ by x100 so largest player fits. TOVERIFY
        ...
        space Y   //----------------------------------------------------------------------
        {
            ...
            block YSysBlock
            {
                ...
                cluster Y_sys
                {
                    ...
                    amode Y_far
                    {
                        #include "..\..\..\..\..\CPUFiles\Y_sys_PL2.dsc"
                        section .ybssbattery;
            ...
            block YAppBlock
            {
                #include "..\..\..\..\..\CPUFiles\Y_AppCluster_PL2.dsc"
            }
