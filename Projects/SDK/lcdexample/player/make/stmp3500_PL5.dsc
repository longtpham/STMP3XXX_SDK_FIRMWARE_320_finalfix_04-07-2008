...
#define INT_P_APP_SZ     (0x5b8f) //(0x5e0c-10) //0x5Ebc

#define INT_P_MDD_ORG    (INT_P_APP_ORG+INT_P_APP_SZ)
//#define INT_P_MDD_SZ    0xA37 //0xA73
#define INT_P_MDD_SZ     (0x959+500+280+217 - 39 - 220 + 42 + 217)	// (0x9f8+760+160) //0xA63	//	0xA7f //0xA37 //0xA73

#define INT_P_SYS_ORG    (INT_P_MDD_ORG+INT_P_MDD_SZ) //Sum is suggestion to locator but locator actually does a best fit
#define INT_P_SYS_SZ     (0x440c+534-160-72-338 + 558) //(0x449d+45) //(0x43e3+104-40+100) //0x41ec //0x43E3 //0x437e //(0x3FEA + 0x210 + 0x5b + 0xD2 + 0x64+0xb7+9)
...
//                              label ModuleRegion_e;
            ...
            block PAppBlock {
                #include "..\..\..\..\..\CPUFiles\P_AppCluster_PL5.dsc"
            }
        ...
        space Y   //----------------------------------------------------------------------
        {
            ...
            block YSysBlock
            {
                ...
                cluster Y_sys
                {
                    ...
                    amode Y_far
                    {
                        #include "..\..\..\..\..\CPUFiles\Y_sys_PL5.dsc"
                        //section .ybssbattery;
            ...
            block YAppBlock
            {
                #include "..\..\..\..\..\CPUFiles\Y_AppCluster_PL5.dsc"
            }
