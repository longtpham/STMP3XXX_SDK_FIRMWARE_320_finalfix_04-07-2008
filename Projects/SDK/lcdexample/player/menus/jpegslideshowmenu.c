...
//
// File        : jpegslideshowmenu.c
// Description : Jpeg slide show menu
////////////////////////////////////////////////////////////////////////////////
#include "types.h"
#include "exec.h"
...
/////////////////////////////////////////////////////////////////////////////////////////
//
//>  Name:          int _reentrant JpegSlideshowMenu(int a, int b, int *pPtr)
//
//   Type:          Function (user menu)
//
//   Description:   This function is the jpeg slideshow menu
//
//   Inputs:        none used.
//
//   Outputs:       value of which menu to return to
//
//   Notes:         This function handles the jpeg slideshow menu.  It loops until a reason
...
int _reentrant JpegSlideshowMenu(int a, int b, int *pPtr)
{
    ...
    INT  iEvent;
    BOOL bDone = FALSE;
    INT  iNewMenu = MENU_SLIDESHOW_MODE;
    ...
    while(!bDone)
    {
        ...
        case EVENT_MESSAGE:
            switch(gEventInfo.Message.wMsgCommand)
            {
				case MENU_JPEG_NEXT_PICTURE:
					...
					SysCallFunction(RSRC_PLAYLIST_CODEBANK,Playlist_GetNextSongFileInfo, 0, 0, (INT*)&SongInfo );
                    ...
                    {
                   	    Jpeg_FillRectangleColor(0,0,LCD_X_SIZE,LCD_Y_SIZE,RGB(0xFF,0xFF,0xFF));
                        SysPostMessage(5,LCD_PRINT_STRING_RSRC,LCD_X_SIZE/5, 0, RSRC_STRING_END_OF_SLIDE_SHOW );
				...
				case MENU_MSG_JPEG_CALLBACK:
					if(bDecodeProgress)
					{
                           ...
                           Jpeg_DecodeDisplay() != JPEG_SUCCESS)
						{
                        	...
                        	SysPostMessage(6,SOFT_TIMER_SET_TIMER,TIMER_ANIMATE,1,2000,MENU_JPEG_NEXT_PICTURE);
                        	SysWaitOnEvent(0,0,0);
						}
					}
					bSendToPlayerStateMachine = FALSE;
        ...
        case EVENT_BUTTON:
            ...
            case PR_AB:
                ...
                break;
			case PR_FF:
                SysPostMessage( 2, MENU_JPEG_NEXT_PICTURE );
	            SysPostMessage(3,SOFT_TIMER_KILL_TIMER,TIMER_ANIMATE);
	            SysWaitOnEvent(0,0,0);
				break;
