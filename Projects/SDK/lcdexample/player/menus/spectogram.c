...
/// ///////////////////////////////////////////////////////////////////////////////////////////
////
//>  Name:          int _reentrant SpectogramMenu(int a, int b, int *pPtr)
//
//   Type:          Function (user menu)
//
//   Description:   This function is the SPECTOGRAM menu
//
//   Inputs:        none used.
//
//   Outputs:       value of which menu to return to
//
//   Notes:         This function handles the spectogram menu.  It loops until a reason
...
//<
//////////////////////////////////////////////////////////////////////////////////////////
int _reentrant SpectogramMenu(int a, int b, int *pPtr)
{
    ...
    g_iCurrentMenu = MENU_SPECTOGRAM;
    DisplayHint.I = 0;
    ...
    DisplayHint.I = SPECTOGRAM_MENU_DISPLAY_ALL|(1<<DISPLAY_CLEAR_DISPLAY_BITPOS);
