...
#ifdef MMC
    ,&g_MediaDescriptor[2],&MMCMediaApi
#endif
};
...
#ifdef MMC
    {&g_DriveDescriptor[2],&MMCDataDriveApi},
#endif
    {&g_DriveDescriptor[NUM_LOGICAL_MEDIA],&RAMSystemDriveApi},
    {&g_DriveDescriptor[NUM_LOGICAL_MEDIA+1],&NANDDataDriveApi},     //hidden
