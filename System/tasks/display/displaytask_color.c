...
#include "..\..\hardware\display\sal\display_sal_color.h"
...
// JLN inserted this ifdef after BR_SDK_3120_MAIN_0025 had link errors for these symbols in mtp.bat
#ifdef USBMSC_BUILD
...
void _reentrant DisplayTask(void)
{
    ...
    while(1)
    {
        ...
        case LCD_CLEAR_RANGE:
            SALDisplayClearRange(Param1,Param2,Param3,Param4,DIRECT_TO_LCD_BUFFER);
            break;
        case LCD_PRINT_RANGE_INV_RSRC:
            bInvert=DISPLAY_INVERT;
        case LCD_PRINT_RANGE_RSRC:
            DisplayPrintBitmapResource(Param1,Param2,Param3,bInvert,DIRECT_TO_LCD_BUFFER);
            break;
        ...
        case LCD_PRINT_STRING_RSRC:
            DisplayPrintStringResource(Param1,Param2,Param3,bInvert,DIRECT_TO_LCD_BUFFER);
            break;
        case LCD_PRINT_STRING_INV_ADDR:
            bInvert=DISPLAY_INVERT;
        case LCD_PRINT_STRING_ADDR:
            DisplayPrintStringAddress(Param1,Param2,(void*)Param3,bInvert,DIRECT_TO_LCD_BUFFER);
            break;
    ...
    //LCD_READ_LCD_ADDR        equ     MSG_TYPE_LCD+10
        ...
        case LCD_PRINT_NUMBER:
            DisplayPrintNumber(Param1/*x*/,Param2/*y*/,Param3/*number*/,Param4/*digits */,Param5/*filler character*/,bInvert,DIRECT_TO_LCD_BUFFER);
            break;
        case LCD_PRINT_TIME_INV:
            bInvert=DISPLAY_INVERT;
        case LCD_PRINT_TIME:
            DisplayPrintTime(Param1/*x*/,Param2/*y*/,Param3/*minutes*/,Param4/*seconds*/,bInvert,DIRECT_TO_LCD_BUFFER);
            break;
        case LCD_PRINT_TIME_LONG_INV:
            bInvert=DISPLAY_INVERT;
        case LCD_PRINT_TIME_LONG:
            DisplayPrintLongTime(Param1/*x*/,Param2/*y*/,Param3/*hours*/,Param4/*minutes*/,Param5/*seconds*/,bInvert,DIRECT_TO_LCD_BUFFER);
            break;
        case LCD_PRINT_STRING_UNICODE_INV_ADDR:
            bInvert=DISPLAY_INVERT;
        case LCD_PRINT_STRING_UNICODE_ADDR:
            DisplayPrintStringAddressUnicode(Param1,Param2,(void*)Param3,bInvert,DIRECT_TO_LCD_BUFFER);
            break;
        case LCD_PRINT_STRING_UNICODE_INV_RSRC:
            bInvert=DISPLAY_INVERT;
        case LCD_PRINT_STRING_UNICODE_RSRC:
            DisplayPrintStringResourceUnicode(Param1,Param2,Param3,bInvert,DIRECT_TO_LCD_BUFFER);
            break;
        case LCD_PRINT_UNICODE_CHAR_INV:
            bInvert=DISPLAY_INVERT;
        case LCD_PRINT_UNICODE_CHAR:
            DisplayPrintCharUnicode   (Param1,Param2,Param3,bInvert,DIRECT_TO_LCD_BUFFER);
            break;
