...
OBJLIST = $(OBJLIST)\
          $(OBJ_PATH)\Philips5767.obj\
          $(OBJ_PATH)\TunerModule.obj

"$(OBJ_PATH)\Philips5767.obj" : $(HW_MSGMODULES_PATH)\Tuner\Philips5767\Philips5767.c
"$(OBJ_PATH)\Philips5767.obj" : $(HW_MSGMODULES_PATH)\Tuner\Philips5767\Philips5767.h
"$(OBJ_PATH)\Philips5767.obj" : $(HW_MSGMODULES_PATH)\Tuner\tunerdriver.h
"$(OBJ_PATH)\Philips5767.obj" : $(OUTPUT_INCLUDE_PATH)\project.h

"$(OBJ_PATH)\tunermodule.obj" : $(HW_MSGMODULES_PATH)\Tuner\tunermodule.c
"$(OBJ_PATH)\tunermodule.obj" : $(HW_MSGMODULES_PATH)\Tuner\Philips5767\Philips5767.h
...
"$(OUTPUT_RSRC_PATH)\TunerModule.src" : $(OUTPUT_PATH)\$(PROJ).abs
        ...
        @$(BIN_PATH)\$(EXTRACT_EXE) $! -M$@=.ptexttunermodule,.ptextphilips5767 -f$(OUTPUT_PATH)\$(PROJ).map
