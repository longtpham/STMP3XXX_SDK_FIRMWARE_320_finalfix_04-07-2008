...
"$(OBJ_PATH)\spistructs.obj" : $(DDI_SPI_PATH)\spistructs.c     $(OUTPUT_INCLUDE_PATH)\regsspi.h
"$(OBJ_PATH)\spihal.obj"     : $(DDI_SPI_PATH)\spihal.c         $(OUTPUT_INCLUDE_PATH)\regsspi.h
$(OBJ_PATH)\spihalasm.obj    : $(DDI_SPI_PATH)\spihalasm.asm    $(OUTPUT_INCLUDE_PATH)\regsspi.h
...
"$(OBJ_PATH)\mmcsalwrite.obj"     : $(PROJECT_H)
...
"$(OUTPUT_RSRC_PATH)\MMCDD.src" : $(OUTPUT_PATH)\$(PROJ).abs
        @echo Extract MMCDD 
        @$(BIN_PATH)\$(EXTRACT_EXE) $! -M$@=MMCDD_Header_p,.ptextspihal,.ptextmmcsal,.ptextmmchalspi,SPI_HAL_ASM_p -f$(OUTPUT_PATH)\$(PROJ).map
