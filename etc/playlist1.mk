...
OBJLIST=    $(OBJLIST)\
            $(OBJ_PATH)\playlist1.obj\
            $(OBJ_PATH)\playlist1_static.obj\
            $(OBJ_PATH)\playlist1mem.obj\
...
INC_ALL_C = $(INC_ALL_C) -Wc-I$(SYS_COMMON_PATH)\playlist1 -Wc-I$(SYS_COMMON_PATH)\lfn
...
$(OBJ_PATH)\playlist1.obj :$(SYS_COMMON_PATH)\playlist1\playlist1.c 
$(OBJ_PATH)\playlist1.obj :$(SYS_COMMON_PATH)\playlist1\playlist1internal.h 
$(OBJ_PATH)\playlist1.obj :$(OUTPUT_INCLUDE_PATH)\sysspeed.h
$(OBJ_PATH)\playlist1.obj :$(OUTPUT_INCLUDE_PATH)\messages.h

$(OBJ_PATH)\playlist1mem.obj :$(SYS_COMMON_PATH)\playlist1\playlist1mem.c $(SYS_COMMON_PATH)\playlist1\playlist1internal.h 

$(OBJ_PATH)\playlist1_static.obj :$(SYS_COMMON_PATH)\playlist1\playlist1_static.c 


"$(OUTPUT_RSRC_PATH)\playlist_codebank.src" : $(OUTPUT_PATH)\$(PROJ).abs
        @echo Extract playlist_codebank 
        @$(BIN_PATH)\$(EXTRACT_EXE) $! -M$@=MenuManager_p,.ptextplaylist1,.ptextfindfirst,.ptextfindnext -f$(OUTPUT_PATH)\$(PROJ).map

#the following are null sources if using playlist1. Here to make the resource linker happy.
"$(OUTPUT_RSRC_PATH)\playlist2init_codebank.src" : $(OUTPUT_PATH)\$(PROJ).abs
        @echo Extract NULL playlist2init_codebank 
	    copy $(PROJRSRC_PATH)\null.src $(OUTPUT_RSRC_PATH)\playlist2init_codebank.src
...
$(OUTPUT_RSRC_PATH)\string_album.src		: $(PROJRSRC_PATH)\null.src
		copy $(PROJRSRC_PATH)\null.src $(OUTPUT_RSRC_PATH)\string_album.src
