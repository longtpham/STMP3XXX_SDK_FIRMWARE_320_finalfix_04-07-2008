@echo off
REM  Filename:    lrAdcTest.bat      
REM  Description: Low Resolution Analog to Digital Converter test for SigmaTel SOC 
rem 
goto :CheckArgs
:EchoUsage
@echo off
...
echo *******************************************
echo ; Usage : lradctest [ALL] DEVICE [LIBS]
echo ;
...
echo ;
echo ; Notes : Low Resolution Analog to Digital Converter test
echo ;         DEBUG build. SDK2400 defines present by default. 
echo *******************************************
@echo off
goto :ERROR
...
if "%1" == "ALL" echo ******************************************* 
if "%1" == "ALL" mk2410 -a -f lradctest.mk clean D_%2=TRUE
if "%1" == "ALL" echo mk2410 -a -f lradctest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
if "%1" == "ALL" mk2410 -a -f lradctest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
if not "%1" == "ALL" echo ******************************************* 
if not "%1" == "ALL" echo **********  Partial rebuild     ***********   
if not "%1" == "ALL" echo *******************************************
if not "%1" == "ALL" echo mk2410 -f lradctest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
if not "%1" == "ALL" mk2410 -f lradctest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
