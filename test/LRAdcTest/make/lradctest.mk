#########################################
# Makefile for Tasking build of LRADCTest
...
## PLAYER ###############################
# Distinguish between Player and USBMSC
...
BLD=$(BLD) -DSTMP_BUILD_LRADCTEST

# must follow standard.mk, where base INC_ALL gets defined
INC_ALL=-I$(PROJRSRC_PATH);$(PROJSUPPORT_PATH);$(PROJ_PATH);$(PROJSYS_PATH);$(OUTPUT_PATH);$(INC_ALL)
...
"$(OBJ_PATH)\lradctest.obj" : $(PROJ_PATH)\lradctest.c  $(OUTPUT_INCLUDE_PATH)\resource.h $(OUTPUT_INCLUDE_PATH)\messages.h 
...
"$(OBJ_PATH)\sysresourcey.obj" : $(SYS_COMMON_PATH)\sysresourcey.asm
...
$(OBJ_PATH)\userkernel.obj : $(PROJSYS_PATH)\userkernel.asm
