...
INT g_MaxAvgRBPerMedia = 4*NUM_BBTABLE_ENTRIES_PER_REGION;
...
{ {2,
  ...
  1,DriveTypeSystem,DRIVE_TAG_STMPSYS_S,49153,TRUE,
  2,DriveTypeSystem,DRIVE_TAG_HOSTLINK_S,81921,TRUE}
