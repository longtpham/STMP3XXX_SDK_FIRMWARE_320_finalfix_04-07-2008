...
"$(OBJ_PATH)\qetest.obj" : $(PROJ_PATH)\qetest.c  $(OUTPUT_PATH)\resource.asm $(OUTPUT_INCLUDE_PATH)\messages.h
...
"$(OBJ_PATH)\rotaryencoder.obj" : $(ROOT)\DeviceDriver\UserInput\RotaryEncoder\rotaryencoder.c
...
"$(OUTPUT_PATH)\$(PROJ).s" : $(OUTPUT_PATH)\$(PROJ).abs
        ...
        @$(BIN_PATH)\stosbcon $(OUTPUT_PATH)\qetest.s $(OUTPUT_PATH)\stmpsys.sb
