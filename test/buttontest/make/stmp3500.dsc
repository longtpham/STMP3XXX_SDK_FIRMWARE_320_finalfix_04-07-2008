/**************************************************************************
**
**  FILE        :  @(#)STMP3500.dsc for buttontest ported from nandrecover ver in sdk3.1
**
**  VERSION     :  
**
        ...
        space P {
            ...
            block P_block {
                ...
                cluster P_clstr {
                    ...
                    amode P_far {
                        reserved addr=0x80 length=0x2400;
                        section selection=x;
                        section selection=w;
        ...
        space X {
            ...
            block X_block {
                ...
                cluster X_clstr {
                    ...
                    amode X_far {
                        reserved addr=0x200 length=0xe00;
                        section selection=w;
                    }
                    amode X_io {
                        // io addressing mode:
        ...
        space Y {
            ...
            block Y_block {
                ...
                cluster Y_clstr {
                    ...
                    amode Y_far {
                        section selection=w;
						reserved label=xvwbuffer length=0x80;
                    }
                    amode Y_io {
                        section selection=w;
                    }
