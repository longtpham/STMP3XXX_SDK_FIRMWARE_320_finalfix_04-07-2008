-OFFE8=0828 -OFFE9=1818 -OFFED=380000
ifndef BIN_DRIVE
BIN_DRIVE=c:
endif
...
INC_ALL_C = $(INC_ALL_C) -Wc-I$(PROJ_PATH) -Wc-I$(OUTPUT_INCLUDE_PATH) -Wc-I$(INC_PATH) -Wc-I$(SYS_COMMON_PATH) -Wc-I$(PROJSUPPORT_PATH) -Wc-I$(SYS_EXEC_PATH)\c_menu_kernel 
...
ALL : $(PROJECT_H) $(OUTPUT_PATH)\resource.asm $(OUTPUT_PATH)\$(PROJ).abs $(OUTPUT_PATH)\$(PROJ).s
    ...
    ifdef D_FM5767
        ...
        ifdef D_FM24000
            ...
            ifdef D_STFM1000
                ...
                #else error: valid TUNERMODEL not specified 
            endif
        endif
    endif
endif
...
"$(OUTPUT_PATH)\$(PROJ).out" : $(CPU_PATH)\testdflt.dsc $(PROJ).mk $(HWEQULIST) $(OBJLIST) $(ALLLIBLIST) $(PROJECT_H) $(LIBLIST)
...
"$(OBJ_PATH)\fmtunertest.obj" : $(PROJ_PATH)\fmtunertest.c  $(OUTPUT_INCLUDE_PATH)\resource.h $(OUTPUT_INCLUDE_PATH)\messages.h
...
$(OBJ_PATH)\mixer.obj : $(HW_MSGMODULES_PATH)\mixer\mixer.asm
...
"$(OBJ_PATH)\fmtunersupport.obj" : $(PROJSUPPORT_PATH)\fmtunersupport.c
...
$(OBJ_PATH)\icoll_c.obj : $(ROOT)\system\hardware\interrupt\icoll_c.c
...
"$(OUTPUT_PATH)\$(PROJ).s" : $(OUTPUT_PATH)\$(PROJ).abs
   ...
   @$(BIN_PATH)\$(EXTRACT_EXE) $! -S$@=P_clstr,X_clstr,Y_clstr  -V$(VERSION) -OFFE8=0828 -OFFE9=1818 -OFFED=380000
   @$(BIN_PATH)\stosbcon $(OUTPUT_PATH)\fmtunertest.s $(OUTPUT_PATH)\stmpsys.sb
