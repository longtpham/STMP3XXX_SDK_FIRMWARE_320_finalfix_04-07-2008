...
"$(OUTPUT_PATH)\$(PROJ).out" : $(PROJ).mk $(CPU_PATH)\testdflt.dsc $(HWEQULIST) $(MODLIST) $(OBJLIST) $(ALLLIBLIST) $(PROJECT_H) $(LIBLIST)
    @echo Linking $(PROJ).out
        @$(LK_EXE) -o $@ $(LK_OPTS) $(match .obj $!) $(LIB_OPT_LIST) $(match .a $!) $(match .a $!) $(match .sym $!)
...
$(OUTPUT_PATH)\resource.asm : $(PROJ_PATH)\resource.inc $(RESOURCE_LIST)
    @echo Creating $@
...
"$(OBJ_PATH)\i2ctest.obj" : "$(PROJ_PATH)\i2ctest.c" "$(OUTPUT_INCLUDE_PATH)\messages.h" "$(OUTPUT_INCLUDE_PATH)\resource.h"
"$(OBJ_PATH)\i2ctest.obj" : "$(INC_PATH)\sysequ.inc" "$(INC_PATH)\sysresources.inc"
...
$(OBJ_PATH)\dbcs.obj: "$(SYS_COMMON_PATH)\dbcs.c" $(OUTPUT_INCLUDE_PATH)\sysequ.h $(OUTPUT_INCLUDE_PATH)\sysresources.h $(OUTPUT_INCLUDE_PATH)\resource.h
