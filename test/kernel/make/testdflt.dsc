                        ...
                        contiguous {
                            ...
                            contiguous {
                                overlay {
                                    ...
                                    section .ptexttask0_region1_bank2 attr=i;
                                    contiguous {
                                        section .ptextdisplaytask;
                                        section .ptextdisplay;
                                        section .ptextdisplayinit;
                                        section .ptextsed15xx;
                                        section .ptextsed15xxinit;
                                        section .ptextframebuffer;
                                        section .ptextdisplaydrv;
                                        }
                                    }
                                }                        
                            label Region1_e;
                            ...
                            contiguous {
                                overlay {
                                    ...
                                    section .ptexttask0_region2_bank1 attr=i;
                                    }
                                }
                            label Region2_e;
                            label Region3_b;
		...
		space Y {
			...
			block Y_block {
				...
				cluster Y_clstr {
					...
					amode Y_far {
						section selection=w;
                        section .yconstresource;//nothing can come after this! (or it may bust)
					}
					amode Y_io {
  						section selection=w;
					}
