...
echo *******************************************
echo ; Usage : lcdtest [ALL] DEVICE [LIBS]
echo ;
...
if "%1" == "ALL" echo ******************************************* 
if "%1" == "ALL" mk2410 -a -f lcdtest.mk clean D_%2=TRUE
if "%1" == "ALL" echo mk2410 -a -f lcdtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE D_%4=TRUE 
if "%1" == "ALL" mk2410 -a -f lcdtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE D_%4=TRUE 

if not "%1" == "ALL" echo ******************************************* 
if not "%1" == "ALL" echo **********  Partial rebuild     ***********   
if not "%1" == "ALL" echo *******************************************
if not "%1" == "ALL" echo mk2410 -f lcdtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE D_%4=TRUE
if not "%1" == "ALL" mk2410 -f lcdtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE D_%4=TRUE
