#########################################
# Makefile for Tasking build of lcdtest
...
#///////////////////////////////////////////////////////////////////////////////
# Link
#/////////////////////////////////////////////////////////////////////////////// TODO instead, use testdefault2.dsc for 64kW P size which we actually have.
#"$(OUTPUT_PATH)\$(PROJ).out" : $(CPU_PATH)\testdefault2.dsc $(HWEQULIST) $(OBJLIST) $(ALLLIBLIST) $(PROJ).mk $(PROJECT_H) $(LIBLIST)
"$(OUTPUT_PATH)\$(PROJ).out" : $(CPU_PATH)\testdflt.dsc $(HWEQULIST) $(OBJLIST) $(ALLLIBLIST) $(PROJ).mk $(PROJECT_H) $(LIBLIST)
...
# Resource build
#///////////////////////////////////////////////////////////////////////////////
$(OUTPUT_PATH)\resource.asm : $(PROJ_PATH)\resource.inc $(RESOURCELIST)
    @echo Creating $@
...
#$(PROJRSRC_PATH)\string_data.src : $(PROJRSRC_PATH)\string_data.txt
...
"$(OBJ_PATH)\lcdtest.obj" : $(PROJ_PATH)\lcdtest.c  $(OUTPUT_INCLUDE_PATH)\resource.h $(OUTPUT_INCLUDE_PATH)\messages.h
...
#///////////////////////////////////////////////////////////////////////////////
# Note: First nibbles below in PXram & PYram cfg registers at x:0xffe8 and x:0xffe9 low nibbles gives KWords of 
# P from X bank (ffe8) & from Y bank (ffe9) so, n+m KWords total P. High nibble of ffe8 is KWords X of space, 
# high nibble of ffe9 is KWords Y. Total P+X+Y addressable RAM size must be 96KWords for 35xx family.
#    0x28 + 0x18== 64kW of P (maxed out)    x: 0x08=8kW   y: 0x18=24kW

"$(OUTPUT_PATH)\$(PROJ).s" : $(OUTPUT_PATH)\$(PROJ).abs
        @echo Extract System S-rec for $(DEVICE) device family
        @$(BIN_PATH)\$(EXTRACT_EXE) $! -S$@=P_clstr,X_clstr,Y_clstr -V$(VERSION) -OFFE8=0828 -OFFE9=1818 
