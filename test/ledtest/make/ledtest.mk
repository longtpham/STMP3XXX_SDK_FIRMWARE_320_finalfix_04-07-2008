#########################################
# Makefile for Tasking build of ledtest
...
"$(OBJ_PATH)\ledtest.obj" : $(PROJ_PATH)\ledtest.c
"$(OBJ_PATH)\ledtest.obj" : $(OUTPUT_INCLUDE_PATH)\messages.h
"$(OBJ_PATH)\ledtest.obj" : "$(OUTPUT_INCLUDE_PATH)\systimers.h" 
"$(OBJ_PATH)\ledtest.obj" : "$(PROJSYS_PATH)\syspostmsg.xref"
"$(OBJ_PATH)\ledtest.obj" : $(SYS_COMMON_PATH)\systime.asm
"$(OBJ_PATH)\ledtest.obj" : $(XREF_PATH)\stackmem.xref
"$(OBJ_PATH)\ledtest.obj" : $(XREF_PATH)\led.xref
"$(OBJ_PATH)\ledtest.obj" : $(XREF_PATH)\systime.xref
"$(OBJ_PATH)\ledtest.obj" : $(PROJ_PATH)\ledtest.h
"$(OBJ_PATH)\ledtest.obj" : $(HW_MSGMODULES_PATH)\led\led.asm
