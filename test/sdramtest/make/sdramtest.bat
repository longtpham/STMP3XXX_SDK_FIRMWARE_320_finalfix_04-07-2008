@echo off
REM  Filename:    SDramTest.bat
REM  Description: Synchronous DRAM test for SigmaTel SOC interfaced with external SDRAM
REM
...
echo *******************************************
echo ; Usage : sdramtest [ALL] DEVICE [LIBS]
echo ;
...
echo ;
echo ; Notes : SDK2400 defines are automatic in this build. DEBUG build.
echo *******************************************
@echo off
goto :ERROR
...
if "%1" == "ALL" echo ******************************************* 
if "%1" == "ALL" echo mk2410 -a -f sdramtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
if "%1" == "ALL" mk2410 -a -f sdramtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
if not "%1" == "ALL" echo ******************************************* 
if not "%1" == "ALL" echo **********  Partial rebuild     ***********   
if not "%1" == "ALL" echo *******************************************
if not "%1" == "ALL" echo mk2410 -f sdramtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
if not "%1" == "ALL" mk2410 -f sdramtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
