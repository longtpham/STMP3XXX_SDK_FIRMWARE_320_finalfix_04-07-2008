...
echo *******************************************
echo ; Usage : Seqledtest [ALL] DEVICE [LIBS]
echo ;
...
echo ;
echo ; Notes : Uses timer API to generate sequential LED patterns
...
if "%1" == "ALL" echo ******************************************* 
if "%1" == "ALL" echo mk2410 -a -f Seqledtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
if "%1" == "ALL" mk2410 -a -f Seqledtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
if not "%1" == "ALL" echo ******************************************* 
if not "%1" == "ALL" echo **********  Partial rebuild     ***********   
if not "%1" == "ALL" echo *******************************************
if not "%1" == "ALL" echo mk2410 -f Seqledtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
if not "%1" == "ALL" mk2410 -f Seqledtest.mk D_%1=TRUE D_%2=TRUE D_%3=TRUE 
